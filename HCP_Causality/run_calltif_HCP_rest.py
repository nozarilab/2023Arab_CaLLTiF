...
# data
import_npz('HCP_Rest_700_Subjects.npz')
...
for s in range(0, num_subjects):
    ...
    # np.savez('multipledataset_calltif_hcp_rest',multipledataset_calltif_hcp_rest_link_matrix = multipledataset_calltif_hcp_rest_link_matrix, multipledataset_calltif_hcp_rest_execution_time = multipledataset_calltif_hcp_rest_execution_time)
