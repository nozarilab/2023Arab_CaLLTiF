...
for r in range(0,num_rep_macaque):
    ...
    # np.savez(os.path.join(results_folder,'CaLLTiF_macaque_full_sweep_both_alpha_lag_3'),calltif_link_matrix_all_macaque = calltif_link_matrix_all_macaque, calltif_macaque_execution_time = calltif_macaque_execution_time, calltif_pval_matrix_all_macaque = calltif_pval_matrix_all_macaque)
