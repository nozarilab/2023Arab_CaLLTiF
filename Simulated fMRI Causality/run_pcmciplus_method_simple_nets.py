...
for n in range(0, num_simple_networks):
       ...
       for r in range(0,num_rep_simple_net):
              ...
              for a in range(0, len(pc_alpha)):
                    ...
                    # np.savez(os.path.join(results_folder,'PCMCIPlus_all_simple_nets'),pcmciplus_link_matrix_all_simple_net = pcmciplus_link_matrix_all_simple_net, pcmciplus_simple_net_execution_time = pcmciplus_simple_net_execution_time, pcmciplus_pval_matrix_all_simple_net = pcmciplus_pval_matrix_all_simple_net)