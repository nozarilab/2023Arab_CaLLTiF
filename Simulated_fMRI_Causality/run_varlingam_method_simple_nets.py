...
# np.savez('Varlingam_all_simple_nets',varlingam_link_matrix_all_simple_net = varlingam_link_matrix_all_simple_net, varlingam_simple_net_execution_time = varlingam_simple_net_execution_time)