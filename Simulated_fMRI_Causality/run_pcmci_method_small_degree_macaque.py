...
for r in range(0,num_rep_macaque):
    ...
    for a1 in range(0, len(pc_alpha)):
                ...
                # np.savez('results_all_method_mecaque/PCMCI_macaque_small_degree_sweep_both_alpha_lag_3_try_more_values_of_pc_alpha',pcmci_link_matrix_all_macaque = pcmci_link_matrix_all_macaque, pcmci_macaque_execution_time = pcmci_macaque_execution_time, pcmci_pval_matrix_all_macaque = pcmci_pval_matrix_all_macaque)
