...
for n in range(0,num_simple_networks):
    ...
    for i in range(0,num_rep_simple_net):
        ...
        for a in range(0,len(mvgc_alpha)):
            ...
            # np.savez('mvgc_all_simple_nets',mvgc_link_matrix_all_simple_net = mvgc_link_matrix_all_simple_net, mvgc_simple_net_execution_time = mvgc_simple_net_execution_time)
