...
# np.savez('PCMCI_all_simple_nets',pcmci_link_matrix_all_simple_net = pcmci_link_matrix_all_simple_net, pcmci_simple_net_execution_time = pcmci_simple_net_execution_time, pcmci_pval_matrix_all_simple_net = pcmci_pval_matrix_all_simple_net)