...
# np.savez('Dynotears_all_simple_nets',dynotears_link_matrix_all_simple_net = dynotears_link_matrix_all_simple_net, dynotears_simple_net_execution_time = dynotears_simple_net_execution_time)