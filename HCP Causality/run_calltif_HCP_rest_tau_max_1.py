...
multipledataset_calltif_hcp_rest_link_matrix_tau_max_1 = []
multipledataset_calltif_hcp_rest_execution_time_tau_max_1 = []
...
for s in range(0, num_subjects):
    ...
    # save results
    multipledataset_calltif_hcp_rest_link_matrix_tau_max_1.append(link_matrix)
    multipledataset_calltif_hcp_rest_execution_time_tau_max_1.append (end - start)

    print('Subject %d'%(s+1), 'Execution time: %0.3f s'%(end-start))
    # np.savez(os.path.join(results_folder,'multipledataset_calltif_hcp_rest_tau_max_1'),multipledataset_calltif_hcp_rest_link_matrix_tau_max_1 = multipledataset_calltif_hcp_rest_link_matrix_tau_max_1, multipledataset_calltif_hcp_rest_execution_time_tau_max_1 = multipledataset_calltif_hcp_rest_execution_time_tau_max_1)
